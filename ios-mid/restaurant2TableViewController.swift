...
class restaurant2TableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if restaurantImageName == one {
            names = ["小灰蝶-1", "小灰蝶-2", "小灰蝶-3","小灰蝶-4", "小灰蝶-5"]
            restaurantNames = ["小灰蝶-1", "小灰蝶-2", "小灰蝶-3","小灰蝶-4", "小灰蝶-5"]
        }
        else if restaurantImageName == two {
            names = ["三線蝶-1", "三線蝶-2", "三線蝶-3", "三線蝶-4", "三線蝶-5"]
            restaurantNames = ["三線蝶-1", "三線蝶-2", "三線蝶-3", "三線蝶-4", "三線蝶-5"]
        }
         else if restaurantImageName ==  three {
            names = ["鳳蝶-1", "鳳蝶-2", "鳳蝶-3","鳳蝶-4", "鳳蝶-5"]
            restaurantNames = ["鳳蝶-1", "鳳蝶-2", "鳳蝶-3","鳳蝶-4", "鳳蝶-5"]
        }
        else{
            names = ["小灰蝶-1", "小灰蝶-2", "小灰蝶-3"]
            restaurantNames = ["小灰蝶-1", "鳳蝶-2","小灰蝶-3"]
        }
